...
Such as:
 ...
 - xref:{rootdir}/config/io_helidon_webserver_grpc_GrpcReflectionFeature.adoc[grpc-reflection (GrpcReflectionFeature)]
 - xref:{rootdir}/config/io_helidon_webserver_cors_CorsFeature.adoc[cors (CorsFeature)]
 - xref:{rootdir}/config/io_helidon_webserver_concurrency_limits_LimitsFeature.adoc[limits (LimitsFeature)]
 - xref:{rootdir}/config/io_helidon_webserver_staticcontent_StaticContentFeature.adoc[static-content (StaticContentFeature)]
 - xref:{rootdir}/config/io_helidon_integrations_eureka_EurekaRegistrationServerFeature.adoc[eureka (EurekaRegistrationServerFeature)]
...
Note that socket named `@default` cannot be used,
