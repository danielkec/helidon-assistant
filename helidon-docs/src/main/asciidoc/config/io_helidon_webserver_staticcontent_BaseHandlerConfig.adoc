...
:basic-table-intro: The table below lists the configuration keys that configure io.helidon.webserver.staticcontent.BaseHandlerConfig
...
Type: link:{javadoc-base-url}/io.helidon.webserver.staticcontent/io/helidon/webserver/staticcontent/BaseHandlerConfig.html[io.helidon.webserver.staticcontent.BaseHandlerConfig]
