...
:description: Configuration of io.helidon.webclient.http1.Http1Client
:keywords: helidon, config, io.helidon.webclient.http1.Http1Client
:basic-table-intro: The table below lists the configuration keys that configure io.helidon.webclient.http1.Http1Client
...
Type: link:{javadoc-base-url}/io.helidon.webclient.http1/io/helidon/webclient/http1/Http1Client.html[io.helidon.webclient.http1.Http1Client]
